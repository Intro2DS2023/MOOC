...
- It sits upon a popular DL backend named [Tensorflow](https://www.tensorflow.org/), also by Google.
...
- You should know the competition by Meta: [PyTorch](https://pytorch.org/)
