...
::: {.notes}
::: {style="direction:rtl; font-size:16px"}
דוגמא נוספת יכולה לבוא מתחום הרפואה ומערכות בריאות. לפנינו מפה של שיעור התמותה מסרטן לפי מחוזות בארצות הברית. ככל שצבע המחוז חם יותר, נוטה לכתום-אדום, כך חריג יותר שיעור התמותה מסרטן במחוז זה. מצד שמאל אנו רואים את שיעורי התמותה של גברים ומצד ימין נשים.
...
נשים לב שהיה זה השלב הזה שהקשר בין סרטן לאסבסט נראה לראשונה, תרשים פשוט של הנתונים.
...
לאורך ההיסטוריה ציירים צירו בסגנונות רבים. האם נוכל לבנות מודל שיוכל להבדיל בין סגנונות ציור?
...
למה פשוט? כי המודל מביא לנוסחה פשוטה: קחו את המספר 1.28, על כל עלייה של פיקסל בצבע אדום תורידו 0.012, על כל עלייה של ירוק תורידו 0.001 ועל כל עלייה של כחול תוסיפו 0.004. את הכמות שנוצרה השוו לאפס, אם גדול נחזה שהציור ריאליסטי, ואם קטן או שווה נחזה שהציור אימפרסיוניסטי.

המודל הזה נותן דיוק של 56 אחוז על מאות ציורים שלא ראה בזמן האימון. מצד אחד ברור שזה לא אחוז דיוק מרשים, מצד שני באמצעות 4 מספרים בלבד התרחקנו כבר מדיוק של 50 אחוז, שמייצד מודל אקראי לחלוטין.
:::
:::
...
::: {.notes}
::: {style="direction:rtl; font-size:16px"}
כמה גבוה אחוז הדיוק שאנו שואפים אליו? ברור שהיינו רוצים 100 אחוזי דיוק, אולם בבעיה שלפנינו אפשר לשאוף רק עד אחוז הדיוק של אדם שצופה בציורים, וכלל לא בטוח שגם אחרי קורס באמנות של המאה ה-19 תוכל להגיד מהו הסגנון של ציורים שמעולם לא ראיתם בדיוק של יותר מ90 אחוז!
...
בקורס זה אנחנו לא פוחדים להשתמש בגזירה ואינטגרציה, בהכפלה והפיכה של מטריצות, לכן נדרש ידע בחשבון דיפרנציאלי ואינטגרלי ובאלגברה ליניארית.
