...
ההטלה של X על vj, היא בעצם UDV'v_j, אבל העמודה v_j יוצרת אפסר במכפלה עם כל העמודות ב-V כי V אורתגונולית, ואילו עם העמודה v_j היא יוצרת 1 כי v_j הוא וקטור יחידה, הנורמה שלו 1.
...
אבל אם כך, מהי בעצם ההטלה של X על אותו v שאנחנו רוצים שהפיזור שלה יהיה כמה שיותר גדול? ההטלה היא בעצם צירוף ליניארי של עמודות U, שהמשקולות שלו הן a1 כפול d1, עד ap כפול dp. ושוב, מאחר שהעמודות של u הן וקטורי יחידה, כשנחשב את הפיזור, או הנורמה של ההטלה הזאת, נגיע למסקנה שגם סכום המשקולות האלה בריבוע הוא 1.
...
::: {.notes}
::: {style="direction:rtl; font-size:16px"}
נושא ה-PCA מרתק גם מהרבה כיוונים אחרים. אפשר םג להגיע לפיתרון על-ידי פתרון בעיית ערכים עצמיים של מטריצה.
:::
:::
...
אם נגזור את הכמות הזאת לפי הרכיבים בv, נקבל את הביטוי שלפנינו, נשווה אותו לאפס ונגיע למסקנה שאנחנו מחפשים וקטור v שיקיים את המשווה שלפנינו. זאת בדיוק משוואה שמגדירה וקטור וערך עצמי של המטריצה X'X, מטריצת הקווריאנס של מדגם הנתונים!
